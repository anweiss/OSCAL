...
<!-- nb A schema and Schematron for the metaschema format should be found nearby. -->
    ...
    <xsl:import href="metaschema-resolve-imports.xsl"/>
    ...
    <xsl:template name="furniture">
        ...
        <!--Produces $all-definitions-->
        <XSLT:import href="metaschema-resolve-imports.xsl"/>
            ...
            <XSLT:variable name="html">
                <XSLT:for-each select="$expanded/*">
                    <html xmlns="http://www.w3.org/1999/xhtml">
                        ...
                        <body>
                            <XSLT:apply-templates select="/METASCHEMA/(* except (define-flag | define-field | define-assembly))"/>
                            
                            <XSLT:apply-templates select="$all-definitions/*"/>
